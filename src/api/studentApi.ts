...
export const apiGetAllStudents = (
  params: ListParams
): Promise<ListResponse<Student>> => axiosClient.get(BASE_URL, { params });
...
export const apiUpdateStudent = (data: Partial<Student>): Promise<Student> =>
  axiosClient.patch(`${BASE_URL}/${data.id}`, { ...data });
